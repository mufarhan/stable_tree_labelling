...
class Graph
{
    ...
    void Decrease_par(ContractionIndex &ci, std::map<NodeID, std::vector<std::pair<distance_t, NodeID> > >& grouping);
    void Increase_par(ContractionIndex &ci, std::map<NodeID, std::vector<std::pair<distance_t, NodeID> > >& grouping);
#endif
...
public:
    ...
    void LabelSearchDec(ContractionIndex &ci, std::vector<std::pair<std::pair<distance_t, distance_t>, std::pair<NodeID, NodeID> > >& updates);
    void LabelSearchInc(ContractionIndex &ci, std::vector<std::pair<std::pair<distance_t, distance_t>, std::pair<NodeID, NodeID> > >& updates);

    void Contract(ContractionIndex &ci, NodeID s, distance_t d);
    void Contract(ContractionIndex &ci, std::vector<std::pair<std::pair<distance_t,distance_t>, NodeID> >& contracted_updates);
    void Decrease_seq(ContractionIndex &ci, std::map<NodeID, std::vector<std::pair<distance_t, NodeID> > >& grouping);
    void Increase_seq(ContractionIndex &ci, std::map<NodeID, std::vector<std::pair<distance_t, NodeID> > >& grouping);

    void ParetoSearchDec(ContractionIndex &ci, std::vector<std::pair<std::pair<distance_t, distance_t>, std::pair<NodeID, NodeID> > >& updates);
    void ParetoSearchInc(ContractionIndex &ci, std::vector<std::pair<std::pair<distance_t, distance_t>, std::pair<NodeID, NodeID> > >& updates);
    void Decrease(NodeID r, NodeID r1, distance_t weight, ContractionIndex &ci, std::vector<int16_t> &NLP, std::vector<NodeID> &VISITED);
    void Increase(NodeID r, NodeID r1, distance_t weight, distance_t delta, ContractionIndex &ci, std::vector<int16_t> &NLP, std::vector<std::pair<int16_t, int16_t> > &AFF, std::vector<NodeID> &VISITED);
    void Repair(ContractionIndex &ci, std::vector<std::pair<int16_t, int16_t> > &AFF, std::vector<NodeID> &VISITED);
